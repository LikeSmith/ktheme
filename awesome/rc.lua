...
mylauncher = awful.widget.launcher({ image = beautiful.hamburger_icon,
                                     menu = mymainmenu })
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey,           }, "Up",
        ...
        {description = "focus next by index", group = "layout"}
    ),
    awful.key({ modkey,           }, "Down",
        function ()
            awful.client.focus.byidx(-1)
        end,
        {description = "focus previous by index", group = "layout"}
    ),
    ...
    awful.key({ modkey }, "b", function() awful.spawn(browser) end,
              {description = "start browser", group = "apps"}),
    awful.key({ modkey }, "e", function() awful.spawn(geditor) end,
              {desctiption = "start editor", group = "apps"})
)
